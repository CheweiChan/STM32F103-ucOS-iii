...
static  void  AppTaskPost ( void * p_arg )
{
	...
	while (DEF_TRUE) {                                                     //任务体
		...
		{		
			...
			OSFlagPost ((OS_FLAG_GRP  *)&flag_grp,                             //将标志组的BIT0清0
                  (OS_FLAGS      )0x01,
		...
		{		
			...
			OSFlagPost ((OS_FLAG_GRP  *)&flag_grp,                             //将标志组的BIT1清0
                  (OS_FLAGS      )0x02,
                  (OS_OPT        )OS_OPT_POST_FLAG_CLR,
                  (OS_ERR       *)&err);
...
static  void  AppTaskPend ( void * p_arg )
{
	...
	while (DEF_TRUE) {                                       //任务体
    OSFlagPend ((OS_FLAG_GRP *)&flag_grp,                  //等待标志组的的BIT0和BIT1均被置1 
                (OS_FLAGS     )( 0X01 | 0X02 ),
                (OS_TICK      )0,
    ...
    OSFlagPend ((OS_FLAG_GRP *)&flag_grp,                  //等待标志组的的BIT0和BIT1有一个被清0 
                (OS_FLAGS     )( 0X01 | 0X02 ),
                (OS_TICK      )0,
